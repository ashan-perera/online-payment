      ...
      <div class="col">
        ...
        <div class="card-header py-3 bg-primary-subtle text-black">
          ...
          <form name="thirdparty" method="post" action="confirm_payment.php">
            <div class="row">
              <div class="col-4"><p class="font-weight-bold">Policy Number </p></div>
              <div class="col-5"><input type="text" name="tpolicy" id="tpolicy" class="form-control" placeholder="Third party policy number" value="PYB209000020"> </div>
            ...
            <!-- <ul class="list-unstyled mt-3 mb-4"> -->
              ...
              <div class="row mt-2 ">
                <div class="col">
                  <label><input type="checkbox" id="chkTerms" name="chkTerms" value="tc" required><strong> I have read &amp; agreed to the<a href="#"> terms &amp; conditions.</a></strong></label>						
			    </div>
            </div>

        
            <div class="paybtn mb-5 mt-2"></div>
            <!-- <button type="button" class="w-30 btn btn-lg btn-danger">Pay Now</button> -->
